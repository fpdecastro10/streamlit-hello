...
def main():
    ...
    app_selection = st.selectbox("",["Distribución de budget","Producto con historial de asignación","Productos nuevos","Stores con tendencia negativa","Stores con tendencia positiva","Distribución de budget cost"])
